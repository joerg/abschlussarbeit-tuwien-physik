...
\newcommand*{\titlePageTUWienPhysik}{
	...
	\begin{figure}[h]
		\centering
\IfEqCase*{\cmdKV@AbschlussarbeitTUWienPhysikTitlePage@schwarzweisslogo}{%
	{true}{\includegraphics[width=0.5\textwidth]{figures/TU_Wien_Logo_SW.pdf}}%
	...
	\centering
	\today & \line(1,0){120}\\Unterschrift StudenIn
	\end{tabular}
	\end{large}
