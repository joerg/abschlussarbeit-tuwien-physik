\documentclass[12pt,a4paper,twoside,BCOR=10mm,openright,bibliography=totoc]{scrreprt} % Schriftgröße, Seitenformat, Zweiseitig für Seitenränder, Bindcorrection
\input{header.tex}
\input{titlepage.tex}
